...
const Textroom = () => {
  ...
  const huddleClient = getHuddleClient(
    "dedb4a37e56b492effabc00442e470df4af70a7a08b0d8a23448a936e4942438"
  );
  ...
  }, [joined, isStreaming, roomState]);

  const handleJoin = async () => {
    try {
      await huddleClient.join("test", {
        address: "0x1ABc133C222a185fEde2664388F08ca12C208F76",
        wallet: "metamask",
        ens: "tebbo.eth",
      });

      console.log("Client ",huddleClient)
      console.log("joined");
    } catch (error) {
      console.log({ error });
    }
